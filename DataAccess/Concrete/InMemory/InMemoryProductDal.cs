...
namespace DataAccess.Concrete.InMemory
{
    public class InMemoryProductDal : IProductDal
    {
        ...
        {
            //oracle,sql server,Postgress 
            //simule ediyormuşuz gibi
      ...
      public   void Delete(Product product)
        {
           ...
           //SingleOrDefaultta Id bazlı yapıları kullanırız.
       ...
       public  List<Product> GetAll()
            //veri tabanındaki datayı business katmanına
            //vermem olayını burda yapıyorum.
        {
